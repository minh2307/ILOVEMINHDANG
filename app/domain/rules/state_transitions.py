...
class JobStateTransitions:
    _transitions: dict[JobStatus, frozenset[JobStatus]] = {
        ...
        JobStatus.PENDING: frozenset({JobStatus.DOWNLOADREEL_RUNNING}),
        ...
        JobStatus.SCREENSHOTS_CAPTURING: frozenset({JobStatus.SCREENSHOTS_CAPTURED, JobStatus.SCREENSHOTS_FAILED, JobStatus.CDHA_FAILED, JobStatus.RETRY_PENDING}),
        JobStatus.SCREENSHOTS_FAILED: frozenset({JobStatus.RETRY_PENDING}),
        ...
        JobStatus.FACEBOOK_PUBLISHING: frozenset({JobStatus.FACEBOOK_PUBLISHED, JobStatus.FACEBOOK_PUBLISH_FAILED, JobStatus.FACEBOOK_PUBLISH_UNCERTAIN, JobStatus.PUBLISH_RECONCILIATION_REQUIRED, JobStatus.POSSIBLE_DUPLICATE_REQUIRES_MANUAL_REVIEW, JobStatus.AUTHENTICATION_REQUIRED}),
        JobStatus.FACEBOOK_PUBLISHED: frozenset({JobStatus.POST_URL_EXTRACTING, JobStatus.POST_URL_EXTRACTED, JobStatus.POSSIBLE_DUPLICATE_REQUIRES_MANUAL_REVIEW}),
        ...
        JobStatus.FACEBOOK_PUBLISH_FAILED: frozenset({JobStatus.RETRY_PENDING, JobStatus.FACEBOOK_SUBMITTED_UNCONFIRMED_EXHAUSTED}),
        JobStatus.POST_URL_EXTRACTION_FAILED: frozenset({JobStatus.RETRY_PENDING, JobStatus.POST_URL_EXTRACTED}),
        ...
        JobStatus.FACEBOOK_SUBMITTED_UNCONFIRMED_EXHAUSTED: frozenset({
            JobStatus.FACEBOOK_SUBMITTED_UNCONFIRMED_EXHAUSTED,
            JobStatus.PUBLISH_RECONCILIATION_REQUIRED,
            JobStatus.FACEBOOK_PUBLISHED,
            JobStatus.POSSIBLE_DUPLICATE_REQUIRES_MANUAL_REVIEW,
        }),
        JobStatus.POSSIBLE_DUPLICATE_REQUIRES_MANUAL_REVIEW: frozenset(),
        ...
        JobStatus.RETRY_PENDING: frozenset({JobStatus.DOWNLOADREEL_RUNNING, JobStatus.GEMINI_OPENING, JobStatus.AI_ANALYZING, JobStatus.CDHA_OPENING, JobStatus.SCREENSHOTS_CAPTURING, JobStatus.FACEBOOK_PREPARING, JobStatus.POST_URL_EXTRACTING, JobStatus.POST_URL_EXTRACTED, JobStatus.COMMENT_ADDING}),
        ...
        JobStatus.BLOCKED_USER_APPROVAL: frozenset({JobStatus.RETRY_PENDING}),
